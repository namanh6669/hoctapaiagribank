"""Buổi 07 - loader, validator và semantic index cho chunk JSON.

Bước 06 bổ sung query embedding, semantic retrieval, confidence gate, generation và citation mapping.
Chưa có Streamlit hoặc test suite đầy đủ.
"""
...
RAG_FOUNDATION_DIR = BASE_DIR.parent
BUOI_05_CHUNKS_DIR = RAG_FOUNDATION_DIR / "buoi_05" / "output" / "chunks"
FIXTURE_CHUNKS_PATH = BASE_DIR / "tests" / "fixtures" / "chunks_sample.json"
